...
namespace Komputerowy_SHOP.Controllers
{
    public class AdresController : Controller
    {
        ...
        public AdresController(Komputerowy_SHOPContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Ulica,Nr,Miasto,Kod_Pocztowy,Kto")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ulica,Nr,Miasto,Kod_Pocztowy,Kto")] Adres adres)
        {
            if (id != adres.Id)
            {
                return NotFound();
